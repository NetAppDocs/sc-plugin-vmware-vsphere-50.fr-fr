...
.Étapes
. Dans le volet de gauche du plug-in SCV, cliquez sur *groupes de ressources*, sélectionnez un groupe de ressources, puis cliquez sur image:scpivs44_image39.png["icône modifier"] *Modifier le groupe de ressources* pour démarrer l'assistant.
